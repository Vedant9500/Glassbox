...
from .universal_proposer import (
    ...
    MULTIVARIATE_FIT_WEIGHT,
    MULTIVARIATE_PRIOR_WEIGHT,
    OPERATOR_PRIOR_SUPPRESSION_THRESHOLD,
    ...
    UNIVARIATE_FIT_WEIGHT,
    UNIVARIATE_PRIOR_WEIGHT,
    UniversalProposer,
